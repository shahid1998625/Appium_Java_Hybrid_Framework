...
public class AndroidDriverManager1 {
    ...
    public static AndroidDriver getDriver_2() {
        if (driver == null) {
            try {
                setUpDriver_2();
            } catch (MalformedURLException | URISyntaxException | FileNotFoundException e) {
...
//          options.setDeviceName("TestPhone");
        ...
        options.setChromedriverExecutable(System.getProperty("user.dir") + "\\src\\main\\java\\com\\QM\\drivers\\chromedriver1.exe"); // Set path where Chromedriver is located
    ...
    private static void setUpDriver_2() throws MalformedURLException, URISyntaxException, FileNotFoundException {
        UiAutomator2Options options = new UiAutomator2Options();
        service = new AppiumServiceBuilder().withAppiumJS(new File("C:\\Users\\Abdulsami_Mohammed\\AppData\\Roaming\\npm\\node_modules\\appium\\build\\lib\\main.js")).withIPAddress("127.0.0.1").usingPort(4723).build();
        service.start();
//          options.setDeviceName("TestPhone");
